    ...
    <div className="fichatecnica">
      <div className="rows">
        ...
        <div className="row c2fr3fr">
          ...
          <p>
            {data.vidaUtil !== ""
              ? `Aproximadamente ${data.vidaUtil} años`
              : ""}
          </p>
        ...
        <div className="row c1fr">
          ...
          <img className="cuadro" alt="foto" src={data.fotoAntes1}></img>
          <img className="cuadro" alt="foto" src={data.fotoAntes2}></img>
        </div>
        <div className="row c1fr">
          <b className="grayed">PLACA N° DE INVENTARIO</b>
          <b className="grayed">FOTO PANORÁMICA DEL BIEN</b>
          <img className="cuadro" alt="foto" src={data.fotoDurante1}></img>
